...
app = Flask(__name__)  #THis is a constructor

# Load the main model of your .pkl file ------------------->
model = joblib.load("student_mark_predictor.pkl")

df = pd.DataFrame()

#It execute our main html page
@app.route('/')
def home():
...
def predict():
    ...
    # OutPut of your main model of your .pkl file ------------------->
    ...
    # Prediction Text for the output of your main model of your .pkl file ------------------->
